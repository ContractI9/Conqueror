...
public CityView(){
	...
	commands = new JPanel();
	combo = new JPanel();
//	Top.setPreferredSize(new Dimension(this.WIDTH,100));
//	Bot.setPreferredSize(new Dimension(this.WIDTH,100));
//	Right.setPreferredSize(new Dimension(648,this.HEIGHT));
